...
def add_comment_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.comment(container=container, comment="Found MV field")
...
def add_comment_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.comment(container=container, comment="No field found")
...
def format_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    parameters = [
        "filtered-data:filter_1:condition_1:artifact:*.cef.destinationHostName"
    ]
    ...
    phantom.format(container=container, template=template, parameters=parameters, name="format_1", separator=",", drop_none=True)
...
def add_note_3(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.add_note(container=container, content=format_1, note_format="markdown", note_type="general", title="Found Hosts")
